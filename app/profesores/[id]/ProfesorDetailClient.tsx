  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-primary overflow-hidden pt-10 px-5 lg:px-8 pb-[88px]">
        <div
          className="absolute w-[420px] h-[420px] opacity-60"
          style={{ background: '#6d0d97', borderRadius: '40% 60% 55% 45% / 50% 45% 55% 50%', top: '-180px', right: '-120px' }}
        />
        <div className="absolute w-[260px] h-[260px] rounded-full bg-[#a83fce] opacity-30" style={{ bottom: '-140px', left: '10%' }} />
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap items-start gap-6">
            <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-neutral-900 shrink-0 bg-neutral-900 flex items-center justify-center animate-float-slow">
              {teacher.photo ? (
            ...
            <div className="flex-1 min-w-[260px] pt-2">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                {teacher.rating && (
                  <div className="flex items-center gap-1.5 bg-white border-2 border-neutral-900 px-3.5 py-2 rounded-full animate-float-slow-2">
              ...
              {teacher.styles.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-3.5">
                  {teacher.styles.map(s => (
                    <span key={s} className="text-xs font-bold bg-white text-primary-dark border-2 border-neutral-900 px-3.5 py-1.5 rounded-full">
                      {s}
                    </span>
                  ))}
                </div>
      ...
      <div className="max-w-5xl mx-auto px-5 lg:px-8 py-8">
        ...
        {activeTab === 'clases' ? (
          ...
          <div className="max-w-2xl">
            ...
            {teacher.whatsapp && (
              <div className="bg-neutral-50 rounded-2xl border-2 border-neutral-900 p-6">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20BC5A] border-2 border-neutral-900 text-white font-bold px-5 py-2.5 rounded-btn text-sm transition-colors active:scale-[0.97]"
                >
