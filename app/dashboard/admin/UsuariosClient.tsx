    ...
    <div className="p-6 lg:p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-600 text-sm mt-1">{total} cuentas creadas</p>
        </div>
      ...
      {total === 0 && (
        <div className="text-center py-20">
          ...
          <p className="text-neutral-600 text-sm mb-6">Las cuentas que crees desde el módulo admin van a aparecer acá.</p>
          ...
          <div className="md:hidden space-y-3">
            {users.map(user => (
              <div key={user.id} className="bg-white rounded-xl border border-neutral-900 p-4 shadow-sm">
                ...
                <p className="text-xs text-neutral-600 mt-1">Creado por {user.creatorName || 'Admin eliminado'}</p>
              </div>
            ))}
          </div>
