...
- **Numeración Secuencial de Migraciones en Supabase:** `develop` y `main` integran `20260921000000_55_blog_post_views.sql` y `20260921000001_56_seed_published_blog_posts.sql`. Nuevas migraciones locales deben continuar la secuencia desde `57_` (`20260921000002_57_...`) para evitar colisiones de ordenamiento en Supabase.
